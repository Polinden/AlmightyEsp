...
<div class="container" id="app">    
    <div class="row">
        <div class="col-xs-8 col-sm-9 col-md-10 offset-md-2 offset-lg-0 col-lg-12 text-center">
          <h1>Keyboard</h1>
	</div>
    </div>
    <div class="row">
        <div v-for="n in 5" class="col-md-6 offset-md-4">
		<template v-for="m in 5">
            <button :id="(n-1)*5+m" @click="inform" type="button" class="btn btn-icon"><i class="fa fa-2x" :class="faar[rnd*n+m*3]" aria-hidden="true"></i></button>{{ ' ' }}
		</template>
        </div>
    </div>
</div>
